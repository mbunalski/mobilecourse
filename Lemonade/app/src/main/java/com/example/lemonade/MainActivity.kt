...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        val lImage: ImageView = findViewById(R.id.lemonImage)
        val lText: TextView = findViewById(R.id.text_action)
        if (lemonadeState == "select"){
            ...
            lText.setText(R.string.lemon_empty_glass)
        }else{
            lImage.setImageResource(R.drawable.lemon_tree)
            lemonadeState = "select"
            lText.setText(R.string.lemon_select)
        }
